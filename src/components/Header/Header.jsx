    ...
    return (
        <motion.header id='hero' className="text-center readex-pro bg-opacity-10 bg-indigo-400 overflow-hidden">
            <div className='w-custom max-w-xl m-auto'>
                ...
                <motion.h1 initial={{ opacity: 0, translateY: 50 }} animate={{ opacity: 1, translateY: 0 }} transition={{ duration: 0.75 }} className='text-5xl/[50px] font-bold mt-5'><span className='text-custom-purple bg-custom-purple bg-opacity-20 px-3 py-1 border-[3px] border-custom-purple border-dashed rounded-lg text-5xl/[80px] '>Le SaaS Ultime</span> pour les vendeurs <span className='text-custom-purple underline decoration-2'>Vinted !</span></motion.h1>
